...
class Stack {
	...
	dispElement(){
		if(this.pointer){
			...
			+this.pointer.epdesc+this.pointer.categ+this.pointer.guest+'</p></center></div><div class="audio-episodes"> <button onclick="Prev()"> <i class="fas fa-chevron-left"></i></button><audio controls src="msc/'+this.pointer.eplink+'"></audio><button onclick="Next()"><i class="fas fa-chevron-right"></i></button></div>';
		} else return "No Data";
	}
